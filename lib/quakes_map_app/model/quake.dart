import 'package:quakes_app/quakes_map_app/util/types_helper.dart';
...
class Properties {
  ...
  Map<String, dynamic> toJson() {
    ...
    data['felt'] = TypesHelper.toInt(this.felt);
    data['cdi'] = this.cdi;
    data['mmi'] = this.mmi;
    data['alert'] = this.alert;
    data['status'] = this.status;
    data['tsunami'] = TypesHelper.toInt(this.tsunami);
    data['sig'] = TypesHelper.toInt(this.sig);
    data['net'] = this.net;
    data['code'] = this.code;
    data['ids'] = this.ids;
